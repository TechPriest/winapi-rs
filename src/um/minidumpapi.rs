...
STRUCT! {struct MINIDUMP_LOCATION_DESCRIPTOR64 {
    DataSize: ULONG64,
    Rva: RVA64,
}}
pub type PMINIDUMP_LOCATION_DESCRIPTOR64 = *mut MINIDUMP_LOCATION_DESCRIPTOR64;
...
STRUCT! {struct MINIDUMP_MEMORY_DESCRIPTOR {
...
STRUCT! {struct MINIDUMP_MEMORY_DESCRIPTOR64 {
    StartOfMemoryRange: ULONG64,
    DataSize: ULONG64,
}}
